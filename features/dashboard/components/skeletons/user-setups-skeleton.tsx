...
const UserSetupsSkeleton = () => {
  return (
    <div className="glass-card hover:glass-card-hover group relative flex flex-col gap-5 rounded-lg border border-neutral-800 bg-neutral-900/80 p-5 backdrop-blur-sm">
      <div className="absolute top-0 right-0 p-3 opacity-10 transition-opacity group-hover:opacity-20">
        <IconSettingsHeart className="size-12 text-white" />
      </div>
